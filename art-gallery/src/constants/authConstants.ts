...
export const COOKIES_REFRESH_COOKIE_MAX_AGE: number = 60 * 60 * 24 * 7; //7 days (deliberatelyt more than refresh token)

export const COOKIES_USER_OBJECT_MAX_AGE: number = 60 * 60 * 24 * 7; //7 days (deliberatelyt more than refresh token)
